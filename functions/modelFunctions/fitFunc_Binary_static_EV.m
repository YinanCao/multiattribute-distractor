function output = fitFunc_Binary_static_EV(attribute, p_data, Nfit, distort_flag, DN_flag, parmEst)

obFunc = @(x) LL_func(attribute,p_data,DN_flag,x(1),x(2),x(3),x(4));
...
if isempty(parmEst)
    ...
    B = [beta; eta; k0; eta];
    B_lim = [beta_lim; eta_lim; k0_lim; eta_lim];
...
function [negLL, p_pred, rel_acc] = LL_func(attribute,p_data,DN_flag,beta,eta_p,k0_p,eta_x)
